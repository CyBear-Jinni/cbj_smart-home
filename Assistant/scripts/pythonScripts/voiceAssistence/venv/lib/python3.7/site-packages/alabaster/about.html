...
<p class="logo">
    <a href="{{ pathto(master_doc) }}">
        <img alt="Logo" class="logo" src="{{ pathto('_static/' ~ theme_logo, 1) }}"/>
...
<p>
    <iframe allowtransparency="true"
            frameborder="0" height="35px" scrolling="0"
            src="https://ghbtns.com/github-btn.html?user={{ theme_github_user }}&repo={{ theme_github_repo }}&type={{ theme_github_type }}&count={{ theme_github_count }}&size=large&v=2"
            width="200px"></iframe>
</p>
{% endif %}
{% endif %}

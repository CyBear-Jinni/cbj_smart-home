...
import 'package:SmartDeviceDart/features/smart_device/infrastructure/datasources/core_datasources/microphone/microphone_c_script.dart';


abstract class HotKeywordDatasourceAbstract {
...
class HotKeywordDatasource extends HotKeywordDatasourceAbstract {
  ...
  Future<bool> listenToVoiceCommand() async {
    try {
      bool didItWork = await _microphone.listenToVoiceCommand().then((
...
class MicrophoneVoiceCommandPc extends HotKeywordDatasourceAbstract {
  @override
  Stream<bool> loopListenToActivateKeyWord() async* {
    while (true) {
	    yield await listenToVoiceCommand();

...
import 'package:SmartDeviceDart/features/smart_device/infrastructure/datasources/smart_server_datasources/protoc_as_dart/smart_connection.pbgrpc.dart';
import 'package:grpc/grpc.dart';


// This class get what to execute straight from the grpc request,
class SmartServerUsecase extends SmartServerServiceBase {

  //  Listening to port and deciding what to do with the response
  void waitForConnection() {
    print('Wait for connection');
    var smartServer = SmartServerUsecase();
    smartServer
  ...
  Future startListen() async {
    final server = Server([SmartServerUsecase()]);

...
class PinInformation {
  ...
  String
      category; //  Category/spec of the pins, Examples: GPIO, USB/Audio/IR, Audio, Debug Port（UART0）
  String
      name; //  Name from the site, Examples: VDD_5V, SYS_3.3V, GND, SCL, SDA, CS, GPIOL11/IR-RX, DEBUG_RX(UART_RXD0)/GPIOA5/PWM0
  String gpioValue; // The gpio value, Examples: 5V, 3V3, GND, IRRX, RXD, TXD
  String mode; //  Examples: IN, OUT, OFF, ALT5
  String
      model; //  Examples: RTL8188CUS/8188EU 802.11n WLAN Adapter, RT2070 Wireless Adapter, mi Wi-Fi mt7601
  String
      description; //  Examples: 5V Power Out, USB1 DP Signal, GPIOL11 or IR Receive, I2S/PCM Serial Data Input

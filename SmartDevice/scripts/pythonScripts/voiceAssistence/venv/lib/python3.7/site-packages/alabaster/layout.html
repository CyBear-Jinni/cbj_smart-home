...
{%- block extrahead %}
{{ super() }}
<link href="{{ pathto('_static/custom.css', 1) }}" rel="stylesheet" type="text/css"/>
{% if theme_touch_icon %}
<link href="{{ pathto('_static/' ~ theme_touch_icon, 1) }}" rel="apple-touch-icon"/>
{% endif %}
...
<a class="github" href="https://github.com/{{ theme_github_user }}/{{ theme_github_repo }}">
    <img alt="Fork me on GitHub" class="github"
